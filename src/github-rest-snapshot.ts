...
export function snapshotInvalidationForMutation(kind:"create_project_field"|"update_project_field_options"|"update_project_item_field_value"|"add_sub_issue"|"add_blocked_by"):SnapshotInvalidationEffect{return kind==="create_project_field"||kind==="update_project_field_options"?"schema":"item";}
