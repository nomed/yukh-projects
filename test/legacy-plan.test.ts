...
-->
`;
function snapshot(converged=false):RestProjectSnapshot{return{subjectRef:"subject",ownerLogin:"example",repositoryName:"atlas",projectNumber:5,repositoryRef:"repository",projectRef:"project",fields:converged?[{id:"area-field",name:"Area",kind:"single_select",options:[{id:"delivery",name:"Delivery"}]},{id:"priority-field",name:"Priority",kind:"single_select",options:[{id:"p0",name:"P0"}]}]:[{id:"priority-field",name:"Priority",kind:"single_select",options:[{id:"p0",name:"P0"}]}],issueTypes:[{id:"gate-type",name:"Gate"}],issues:new Map([[27,{issueRef:"issue-27",issueDatabaseId:27,body,itemRef:"item-27",fingerprint:"fingerprint",values:{Priority:"P0",...(converged?{Area:"Delivery"}:{})},...(converged?{issueType:"Gate",parent:1}:{}),labels:[],issueFields:{},blockedBy:[],blocking:[],relationshipsComplete:true}]]),evidence:{restRequests:5,graphqlRequests:0,restCacheHits:0,conditionalRequests:0,coalescedRequests:0}};}
