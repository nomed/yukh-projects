...
const scope={ownerLogin:"example-labs",repositoryName:"atlas",projectNumber:7,issueNumber:42};
const policy=`schema: 1\nfields:\n  work_type:\n    name: Work Type\n    kind: single_select\n    mode: managed\n    options:\n      task: Task\n  area:\n    name: Area\n    kind: single_select\n    mode: managed\n    options:\n      core: Core\n`;
const body=`<!-- yukh:issue:v1\nschema: 1\nwork_type: task\narea: core\n-->`;
const end={hasNextPage:false,endCursor:null};
const data:Record<AllowedReadOperation,unknown>={resolve_scope:{...scope,subjectRef:"github:synthetic-bot",repositoryRef:"repo:1",projectRef:"project:1",issueRef:"issue:1",issueBody:body},read_project_fields:{projectRef:"project:1",nodes:[{id:"field:1",name:"Work Type",kind:"single_select",options:[{id:"option:1",name:"Task"}]},{id:"field:2",name:"Area",kind:"single_select",options:[{id:"option:2",name:"Core"}]}],pageInfo:end},read_project_item:{projectRef:"project:1",issueRef:"issue:1",itemRef:"item:1",fingerprint:"item-fingerprint",nodes:[{key:"Work Type",value:"Task"},{key:"Area",value:"Core"}],pageInfo:end},read_issue_relationships:{repositoryRef:"repo:1",issueRef:"issue:1",nodes:[{issueNumber:42}],parent:[],blocks:[],pageInfo:end}};
